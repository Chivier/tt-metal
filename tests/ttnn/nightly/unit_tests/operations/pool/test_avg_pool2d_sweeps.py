...
parameters = {
    "input_specs": [
        ...
        [1, 1056, 14, 14, 2, 2, 2, 2, 0, 0, False, True, None],
        ...
        # [1, 1024, 17, 17, 3, 3, 1, 1, 1, 1, False, False, None], #hangs height
        [1, 112, 14, 14, 2, 2, 2, 2, 0, 0, False, True, None],
        # [1, 1536, 8, 8, 3, 3, 1, 1, 1, 1, False, False, None], #issue with width sharding
    ...
    "failing_parameters": [
        ...
        [1, 24, 56, 56, 2, 2, 2, 2, 0, 0, False, True, None],  # 13
        [1, 40, 28, 28, 2, 2, 2, 2, 0, 0, False, True, None],  # 15
        [1, 80, 14, 14, 2, 2, 2, 2, 0, 0, False, True, None],  # 16
    ],
}
