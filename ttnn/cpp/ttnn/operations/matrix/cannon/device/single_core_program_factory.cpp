...
CannonDeviceOperation::SingleCore::cached_program_t CannonDeviceOperation::SingleCore::create(
...
void CannonDeviceOperation::SingleCore::override_runtime_arguments(
