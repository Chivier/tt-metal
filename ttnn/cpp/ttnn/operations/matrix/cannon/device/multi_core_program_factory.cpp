...
CannonDeviceOperation::MultiCore::cached_program_t CannonDeviceOperation::MultiCore::create(
...
void CannonDeviceOperation::MultiCore::override_runtime_arguments(
